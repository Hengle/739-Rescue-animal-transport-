...
public class CAIronSourceUninstallSettings : Editor
{
	const string adnetworkTitle = "IronSource";
	...
	{
		CAIronSourceUninstall ironSourceUninstall =  new CAIronSourceUninstall();
		ironSourceUninstall.unistall();
	}

	class CAIronSourceUninstall
	{
        ...
        private readonly string[] kPluginFiles = {
			kIOSPluginsPath       +   "/libironsource-mediation.a",
			kAndroidPluginsPath   +   "/ironsource-mediation.aar",
			kAssets               +   "/Consoliads/Editor/CAIronSourceUninstallSettings.cs"
		};

		private string[] kPluginFolders = {
			kIOSPluginsPath   +   "/IronSource.framework"
		};
