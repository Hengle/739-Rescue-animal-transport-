...
public class CAUnityAdUninstallSettings : Editor
{
	const string adnetworkTitle = "UnityAds";
	...
	{
		CAUnityAdUninstall unityAdsUnistall =  new CAUnityAdUninstall();
		unityAdsUnistall.unistall();
	}

	class CAUnityAdUninstall
	{
        ...
        private readonly string[] kPluginFiles = {
			kIOSPluginsPath       +   "/libunityads-mediation.a",
			kAndroidPluginsPath   +   "/unity-ads.aar",
			kAndroidPluginsPath   +   "/unityads-mediation.aar",
			kAssets               +   "/Consoliads/Editor/CAUnityAdUninstallSettings.cs"
