...
public class CAFacebookAudienceUninstallSettings : Editor
{
	const string adnetworkTitle = "Facebook Audience Network";
    ...
    {
        CAFacebookAudienceUninstall audienceNetworkUninstall =  new CAFacebookAudienceUninstall();
        audienceNetworkUninstall.unistall();
    }

    class CAFacebookAudienceUninstall
    {
        ...
        private readonly string[] kPluginFiles = {
            kIOSPluginsPath       +   "/libfacebook-mediation.a",
        ...
        private string[] kPluginFolders = {
            kIOSPluginsPath   +   "/FBAudienceNetwork.framework",
            kIOSPluginsPath   +   "/FBSDKCoreKit"
        };
