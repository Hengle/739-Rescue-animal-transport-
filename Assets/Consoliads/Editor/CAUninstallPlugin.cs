...
public class CAUninstallPlugin
{
    ...
    private static string[] kPluginFiles = {
		...
		kAssets                                 +   "/Editor/CABuildPreProcessor.cs",
		kAssets                                 +   "/Consoliads/Editor/CASettings.cs",
		kAssets                                 +   "/Consoliads/Editor/CAUninstallPlugin.cs",
		kAssets                                 +   "/Consoliads/Editor/ConsoliAdsDependencies.xml",
