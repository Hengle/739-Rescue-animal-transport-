...
public class CAAdcolonyUninstallSettings : Editor
{
	const string adnetworkTitle = "Adcolony";
    ...
    {
        CAAdcolonyUninstall adcolonyUnistall =  new CAAdcolonyUninstall();
        adcolonyUnistall.unistall();
    }

    class CAAdcolonyUninstall
    {
        ...
        private readonly string[] kPluginFiles = {
            kIOSPluginsPath       +   "/libadcolony-mediation.a",
            kAndroidPluginsPath   +   "/adcolony-mediation.aar",
            kAssets               +   "/Consoliads/Editor/CAAdcolonyUninstallSettings.cs"
        };
