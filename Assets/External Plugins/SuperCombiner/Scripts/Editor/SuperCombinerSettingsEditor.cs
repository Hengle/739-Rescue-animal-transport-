...
namespace LunarCatsStudio.SuperCombiner
{
    ...
    public class SuperCombinerSettingsEditor : Editor
    {
        ...
        private void DisplayMaterialSettings()
        {
            ...
            {
                _sc_settings.materialSettings.multipleMaterialsMode = EditorGUILayout.Toggle(new GUIContent("Multiple materials", "The multi material feature lets you combine to several materials (up to 3) from the listed source materials. This is usually usefull when combining meshes that have various materials (submeshes) that cannot be combined together."), _sc_settings.materialSettings.multipleMaterialsMode);
        ...
        private void DisplayMeshSettings()
        {
            ...
            if (_show_mesh_settings)
            {
                ...
                if (_sc_settings.meshSettings.combineMeshs)
                {
                    ...
                    _sc_settings.meshSettings.maxVerticesCount = EditorGUILayout.IntSlider(new GUIContent("Max vertices count", "If the combined mesh has more vertices than this parameter, it will be split into various meshes with 'Max vertices count' vertices"), _sc_settings.meshSettings.maxVerticesCount, MeshSettings.MIN_MESHS, MeshSettings.MAX_MESHS, GUILayout.ExpandWidth(true));
                }
