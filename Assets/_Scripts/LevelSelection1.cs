...
public class LevelSelection1 : MonoBehaviour
{
	...
	void Start ()
	{
		...
		lastno = 0;
		int no = PlayerPrefs.GetInt ("LUnlockLevels");
		int UnlockedLevel = PlayerPrefs.GetInt ("LUnlockLevels");
		if (no == 0) { 
			//  no= 1;

			PlayerPrefs.SetInt ("LUnlockLevels", 1);
...
//			SoundManager.Instance.ButtonSound ();
			...
			PlayerPrefs.SetInt ("LLevel", lastno);
