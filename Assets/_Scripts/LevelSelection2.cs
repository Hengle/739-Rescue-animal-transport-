...
public class LevelSelection2 : MonoBehaviour
{
	...
	void Start ()
	{
		...
		lastno = 0;
		int no = PlayerPrefs.GetInt ("SUnlockLevels");
		int UnlockedLevel = PlayerPrefs.GetInt ("SUnlockLevels");
		if (no == 0) { 
			//  no= 1;

			PlayerPrefs.SetInt ("SUnlockLevels", 1);
...
//			SoundManager.Instance.ButtonSound ();
			...
			print ("levels");
			PlayerPrefs.SetInt ("SLevel", lastno);
