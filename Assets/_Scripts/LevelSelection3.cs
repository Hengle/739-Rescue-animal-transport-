...
public class LevelSelection3 : MonoBehaviour
{
	...
	void Start ()
	{
		...
		lastno = 0;
		int no = PlayerPrefs.GetInt ("CUnlockLevels");
		int UnlockedLevel = PlayerPrefs.GetInt ("CUnlockLevels");
		if (no == 0) { 
			//  no= 1;

			PlayerPrefs.SetInt ("CUnlockLevels", 1);
...
//			SoundManager.Instance.ButtonSound ();
			...
			print ("levels");
			PlayerPrefs.SetInt ("CLevel", lastno);
