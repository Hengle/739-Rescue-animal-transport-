...
public class LevelSelection : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        lastno = 0;
        int no = PlayerPrefs.GetInt("HUnlockLevels");
        int UnlockedLevel = PlayerPrefs.GetInt("HUnlockLevels");
        if (no == 0)
        {
            //  no= 1;

            PlayerPrefs.SetInt("HUnlockLevels", 1);
    ...
    public void OnPlay()
    {
        ...
        print("levels");
        PlayerPrefs.SetInt("HLevel", lastno);
        //		Invoke ("wait",5f);
