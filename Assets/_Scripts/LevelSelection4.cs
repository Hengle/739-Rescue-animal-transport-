...
public class LevelSelection4 : MonoBehaviour
{
	...
	void Start ()
	{
		...
		lastno = 0;
		int no = PlayerPrefs.GetInt ("DUnlockLevels");
		int UnlockedLevel = PlayerPrefs.GetInt ("DUnlockLevels");
		if (no == 0) { 
			//  no= 1;

			PlayerPrefs.SetInt ("DUnlockLevels", 1);
...
//			SoundManager.Instance.ButtonSound ();
			...
			print ("levels");
			PlayerPrefs.SetInt ("DLevel", lastno);
//			SoundManager.Instance.StopGamePlaySound ();
